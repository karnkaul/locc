...
std::deque<locc::entry> locc::parse(int argc, char const* const* argv)
{
...
locc::value const* locc::find(std::deque<entry> const& entries, key const& key)
{
